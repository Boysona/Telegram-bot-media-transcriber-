...
if os.path.exists(user_media_language_settings_file):
    with open(user_media_language_settings, 'r') as f:
        try:
...
LANGUAGES = [
    ...
    {"name": "Arabic", "flag": "🇸🇦", "code": "ar-SA"}, # Moved up
    {"name": "Spanish", "flag": "🇪🇸", "code": "es-ES"}, # Moved up
    {"name": "Hindi", "flag": "🇮🇳", "code": "hi-IN"},   # Moved up
    {"name": "French", "flag": "🇫🇷", "code": "fr-FR"}, # Moved up
    {"name": "German", "flag": "🇩🇪", "code": "de-DE"}, # Moved up
    {"name": "Chinese", "flag": "🇨🇳", "code": "zh-CN"}, # Moved up
    {"name": "Japanese", "flag": "🇯🇵", "code": "ja-JP"}, # Moved up
    {"name": "Portuguese", "flag": "🇵🇹", "code": "pt-PT"}, # Moved up
    {"name": "Russian", "flag": "🇷🇺", "code": "ru-RU"}, # Moved up
    {"name": "Turkish", "flag": "🇹🇷", "code": "tr-TR"}, # Moved up
    {"name": "Korean", "flag": "🇰🇷", "code": "ko-KR"}, # Moved up
    {"name": "Italian", "flag": "🇮🇹", "code": "it-IT"}, # Moved up
    {"name": "Indonesian", "flag": "🇮🇩", "code": "id-ID"}, # Moved up
    {"name": "Vietnamese", "flag": "🇻🇳", "code": "vi-VN"}, # Moved up
    {"name": "Thai", "flag": "🇹🇭", "code": "th-TH"}, # Moved up
    {"name": "Dutch", "flag": "🇳🇱", "code": "nl-NL"}, # Moved up
    {"name": "Polish", "flag": "🇵🇱", "code": "pl-PL"}, # Moved up
    {"name": "Swedish", "flag": "🇸🇪", "code": "sv-SE"}, # Moved up
    {"name": "Filipino", "flag": "🇵🇭", "code": "fil-PH"}, # Moved up
    {"name": "Greek", "flag": "🇬🇷", "code": "el-GR"}, # Moved up
    {"name": "Hebrew", "flag": "🇮🇱", "code": "he-IL"}, # Moved up
    {"name": "Hungarian", "flag": "🇭🇺", "code": "hu-HU"}, # Moved up
    {"name": "Czech", "flag": "🇨🇿", "code": "cs-CZ"}, # Moved up
    {"name": "Danish", "flag": "🇩🇰", "code": "da-DK"}, # Moved up
    {"name": "Finnish", "flag": "🇫🇮", "code": "fi-FI"}, # Moved up
    {"name": "Norwegian", "flag": "🇳🇴", "code": "nb-NO"}, # Moved up
    {"name": "Romanian", "flag": "🇷🇴", "code": "ro-RO"}, # Moved up
    {"name": "Slovak", "flag": "🇸🇰", "code": "sk-SK"}, # Moved up
    {"name": "Ukrainian", "flag": "🇺🇦", "code": "uk-UA"}, # Moved up
    {"name": "Malay", "flag": "🇲🇾", "code": "ms-MY"}, # Moved up
    {"name": "Bengali", "flag": "🇧🇩", "code": "bn-BD"}, # Moved up
    {"name": "Tamil", "flag": "🇮🇳", "code": "ta-IN"}, # Moved up
    {"name": "Telugu", "flag": "🇮🇳", "code": "te-IN"}, # Moved up
    {"name": "Kannada", "flag": "🇮🇳", "code": "kn-IN"}, # Moved up
    {"name": "Malayalam", "flag": "🇮🇳", "code": "ml-IN"}, # Moved up
    {"name": "Gujarati", "flag": "🇮🇳", "code": "gu-IN"}, # Moved up
    {"name": "Marathi", "flag": "🇮🇳", "code": "mr-IN"}, # Moved up
    {"name": "Urdu", "flag": "🇵🇰", "code": "ur-PK"}, # Moved up
    {"name": "Nepali", "flag": "🇳🇵", "code": "ne-NP"}, # Moved up
    {"name": "Sinhala", "flag": "🇱🇰", "code": "si-LK"}, # Moved up
    {"name": "Khmer", "flag": "🇰🇭", "code": "km-KH"}, # Moved up
    {"name": "Lao", "flag": "🇱🇦", "code": "lo-LA"}, # Moved up
    {"name": "Burmese", "flag": "🇲🇲", "code": "my-MM"}, # Moved up
    {"name": "Georgian", "flag": "🇬🇪", "code": "ka-GE"}, # Moved up
    {"name": "Armenian", "flag": "🇦🇲", "code": "hy-AM"}, # Moved up
    {"name": "Azerbaijani", "flag": "🇦🇿", "code": "az-AZ"}, # Moved up
    {"name": "Kazakh", "flag": "🇰🇿", "code": "kk-KZ"}, # Moved up
    {"name": "Uzbek", "flag": "🇺🇿", "code": "uz-UZ"}, # Moved up
