...
Enjoy transcribing and downloading your media files and TikTok videos quickly and easily! If you have any questions or feedback, feel free to reach out in the channel."""
    )
...
def status_handler(message):
    ...
    # Tirinta isticmaaleyaasha maanta
...
def callback_transcribe_tiktok(call):
    ...
    try:
        ...
        # update total_processing_time if you measure it here
...
def handle_file(message):
    ...
    try:
        ...
        with open(local_path, 'wb') as f:
            f.write(data)
        bot.send_chat_action(message.chat.id, 'typing')
        global processing_start_time, total_files_processed, total_audio_files, total_voice_clips, total_processing_time
