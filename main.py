...
def set_bot_info():
    ...
    bot.set_my_description("What You Can Do After Using This Bot:
🎙️ Transcribe voice, audio & video with ease
🌍 Translate text into multiple languages instantly
🛡️ Protect your groups with smart anti-spam filters
🤖 Chat with Gemini – your intelligent AI assistant
")
    bot.set_my_short_description("Smart bot for media transcribing, text translation, anti-spam & Gemini AI chat — fast, simple & free!")
...
def handle_translate(message):
    ...
    msg = bot.send_message(message.chat.id, "Write the language you want this text to be translated into, such as: Arabic, Spanish, etc. If you want a brief or detailed translation, specify that as well🥱 I'm waiting for you...")
