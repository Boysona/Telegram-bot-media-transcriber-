...
def set_bot_info():
    commands = [
        ...
        telebot.types.BotCommand("privacy", "View Privacy Notice"), # New command
    ]
...
bot.set_my_description(
    description="Transcribe voice messages, audio files, videos, and TikToks for free, then translate or summarize them instantly."
)
...
This bot helps you quickly transcribe, summarize, and translate various media files and TikTok videos.

**Here's what I can do for you:**

-   **Transcribe anything:** Send me voice messages, audio files, video files, video notes, or even TikTok video links. I'll convert the audio to text.
-   **Summarize content:** Get concise summaries of your transcriptions.
-   **Translate text:** Translate your transcriptions into various languages.
-   **TikTok downloads:** Download TikTok videos directly by sending their links.

**Commands:**

-   `/start`: Restart the bot and see the welcome message.
-   `/status`: Check bot statistics and usage.
-   `/language`: Set your preferred language for translations and summaries.
-   `/privacy`: Read about how your data is handled.
"""
    )
    bot.send_message(message.chat.id, help_text, parse_mode="Markdown")

# --- New Privacy Notice Command ---
@bot.message_handler(commands=['privacy'])
def privacy_notice_handler(message):
    privacy_text = (
        """
🔒 **Privacy Notice for Transcriber Bot**

Your privacy is important to us. This notice explains how Transcriber Bot handles your data.

**What data do we collect?**
* **User IDs:** We store your Telegram User ID to manage your language settings and track your activity (e.g., when you last used the bot).
* **Media files:** When you send voice messages, audio, video, or TikTok links, these files are temporarily downloaded to our server for processing (transcription, summarization, translation, or download).
* **Transcriptions and AI interactions:** The text generated from your media (transcriptions, summaries, translations) is processed by a third-party AI service (Gemini API) and is also temporarily stored in the bot's memory for a short period to facilitate follow-up actions (like translating or summarizing).

**How do we use your data?**
* To **provide the core services** of the bot: transcribing, summarizing, translating your media, and downloading TikTok videos.
* To **personalize your experience**: Your preferred language setting helps us deliver summaries and translations in your chosen language.
* To **improve bot functionality**: Aggregated, anonymous usage statistics (e.g., total files processed) help us understand bot performance.

**Do we share your data?**
* **Third-Party AI Service:** Your transcriptions and prompts for summarization/translation are sent to the **Gemini API** for processing. Google's privacy policy applies to their handling of this data.
* We **do not share your personal data** (like your User ID or chat content) with any other third parties for marketing or other purposes.

**How long do we store your data?**
* **Media files:** All uploaded media files are **deleted immediately** after processing. They are not stored permanently.
* **Transcriptions and AI interactions:** These are stored in the bot's temporary memory for a short duration to handle consecutive requests (e.g., if you ask to summarize a transcription). They are **not stored permanently** on our servers.
* **User IDs and language settings:** These are stored to maintain your preferences and activity status.

**Your Consent:**
By using this bot, you consent to the data practices described in this Privacy Notice.

If you have any questions or concerns about your privacy, please contact our support channel: @transcriberbo
"""
    )
