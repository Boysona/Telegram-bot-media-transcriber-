...
def start_handler(message):
    ...
    # Check subscription for /start command
    if str(message.from_user.id) != str(ADMIN_ID): # Skip admin for subscription check
...
def generate_language_keyboard(callback_prefix: str, message_id: int | None = None):
    ...
    # With a row_width of 3, a large number of languages will naturally span many rows (lines)
...
TTS_VOICES_BY_LANGUAGE = {
    ...
    "Arabic 🇸🇦": [
        ...
        "ar-SY-AmiraNeural", "ar-SY-LaithNeural",
