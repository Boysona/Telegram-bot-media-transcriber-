...
def set_bot_info():
    ...
    bot.set_my_short_description(
        short_description="This bot transcribes audio, video & TikTok links into text — fast, accurate, and free. Supports translation & summarization."
    )

    bot.set_my_description(
        description="""This bot transcribes voice messages, audio files, video files, and even TikTok links automatically.
