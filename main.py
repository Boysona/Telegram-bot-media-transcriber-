...
def set_bot_info():
    ...
    try:
        ...
        bot.set_my_description(description="This bot can transcribe voice, audio, and video to text in multiple languages with automatic detection - fast, easy, and free! Use new translate and summarize transcription results after transcribing Try it now.")
...
Enjoy transcribing, translating, and summarizing your media files quickly and easily! If you have any questions or feedback, feel free to reach out in the channel."""
...
def handle_summarize(message):
    ...
    msg = bot.send_message(
        message.chat.id,
        "Please type and send the language you want the summary in (e.g., English, Somali):"
    )
