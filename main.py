...
import yt_dlp  # ← added for TikTok download
...
def set_bot_info():
    ...
    try:
        ...
        bot.set_my_description(
            description="This bot helps you transcribe voice messages, audio files, videos, and TikTok links — quickly and for free!

You can:

• 🎧 Transcribe audio, voice massages, videos & TikTok video  clips
• 📥 Download TikTok videos directly
• 🌐 Translate transcribed text into any language
• 📝 Summarize  content
• ⚡ Supports all languages, auto-detects speech instantly!"
        )
        bot.set_my_short_description(
            short_description=" Transcribe Audio files, Voice messages & Videos — Fast, Easy & FREE!"
        )
