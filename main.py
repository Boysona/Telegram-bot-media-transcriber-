...
def handle_translate(message):
    ...
    msg = bot.send_message(
        message.chat.id,
        "Write the language you want this text to be translated into, such as: Arabic, Spanish, etc. "
        "If you want a brief or detailed translation, specify that as well. 🥱"
    )
